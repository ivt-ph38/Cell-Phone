				...
				<div class="row" >
					...
					<div class="product">
						...
						<div class="product-body">
							...
							<h4 class="product-price">12344<del class="product-old-price">$990.00</del></h4>
						...
						<div class="add-to-cart">
							<button class="add-to-cart-btn" ng-click = "a3()"><i class="fa fa-shopping-cart" ></i> add to cart test</button>
						</div>
					</div>
